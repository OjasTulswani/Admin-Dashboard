      ...
      <BrowserRouter>
        <div className="flex relative dark:bg-main-dark-bg">
          ...
          {activeMenu ? (
            ...
            <div className="w-0 dark:bg-secondary-dark-bg ">Sildebar</div>
          )}
          {/* {slidsbar closes} */}
          ...
          >
            {/* created className as template literal and pass the active menu as a varible plus with tertinary  */}
